...
typedef void (*audio_session_callback)(sp<media::AudioSessionInfo>& session, bool added);
...
private:
    ...
    public:
        ...
        virtual void onOutputSessionEffectsUpdate(sp<media::AudioSessionInfo>& info, bool added);
