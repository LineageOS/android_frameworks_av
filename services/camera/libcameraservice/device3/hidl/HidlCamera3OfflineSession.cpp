...
hardware::Return<void> HidlCamera3OfflineSession::processCaptureResult_3_4(
    ...
    HidlCaptureOutputStates states {
      { mId,
        ...
        mBufferRecords, /*legacyClient*/ false, /*privilegedClient*/ false, mMinExpectedDuration,
        mIsFixedFps, CameraCompatibilityInfo(), activePhysicalId}, mResultMetadataQueue
    };
