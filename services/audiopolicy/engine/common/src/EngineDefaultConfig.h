    ...
    {"STRATEGY_PHONE", static_cast<int>(AudioProductStrategyType::PHONE),
         AudioProductStrategy::DEFAULT_ZONE_ID,
         {
             ...
             {AUDIO_STREAM_BLUETOOTH_SCO, "AUDIO_STREAM_BLUETOOTH_SCO",
                     {{AUDIO_CONTENT_TYPE_UNKNOWN, AUDIO_USAGE_UNKNOWN, AUDIO_SOURCE_INVALID,
                              AUDIO_FLAG_SCO,""}},
             }
         },
    },
    {"STRATEGY_SONIFICATION", static_cast<int>(AudioProductStrategyType::SONIFICATION),
         AudioProductStrategy::DEFAULT_ZONE_ID,
         {
             ...
             {AUDIO_STREAM_ALARM, "AUDIO_STREAM_ALARM",
                {{AUDIO_CONTENT_TYPE_UNKNOWN, AUDIO_USAGE_ALARM, AUDIO_SOURCE_INVALID,
                    AUDIO_FLAG_NONE, ""}},
             }
         },
    },
    ...
    {"STRATEGY_SONIFICATION_RESPECTFUL",
         ...
         AudioProductStrategy::DEFAULT_ZONE_ID,
         {
             {AUDIO_STREAM_NOTIFICATION, "AUDIO_STREAM_NOTIFICATION",
                  {
                      {AUDIO_CONTENT_TYPE_UNKNOWN, AUDIO_USAGE_NOTIFICATION, AUDIO_SOURCE_INVALID,
                       AUDIO_FLAG_NONE, ""},
    ...
    {"STRATEGY_MEDIA", static_cast<int>(AudioProductStrategyType::MEDIA),
        AudioProductStrategy::DEFAULT_ZONE_ID,
        {
            {AUDIO_STREAM_MUSIC, "AUDIO_STREAM_MUSIC",
                {
                    {AUDIO_CONTENT_TYPE_UNKNOWN, AUDIO_USAGE_MEDIA, AUDIO_SOURCE_INVALID,
                        AUDIO_FLAG_NONE, ""},
                    {AUDIO_CONTENT_TYPE_UNKNOWN, AUDIO_USAGE_GAME, AUDIO_SOURCE_INVALID,
                        AUDIO_FLAG_NONE, ""},
    ...
    {"STRATEGY_CALL_ASSISTANT",
         ...
         AudioProductStrategy::DEFAULT_ZONE_ID,
         {
             {AUDIO_STREAM_CALL_ASSISTANT, "AUDIO_STREAM_CALL_ASSISTANT",
                {{AUDIO_CONTENT_TYPE_UNKNOWN, AUDIO_USAGE_CALL_ASSISTANT, AUDIO_SOURCE_INVALID,
                AUDIO_FLAG_NONE, ""}}
             }
         },
    },
            ...
            {AUDIO_STREAM_TTS, "AUDIO_STREAM_TTS",
                  {
                      {AUDIO_CONTENT_TYPE_UNKNOWN, AUDIO_USAGE_UNKNOWN, AUDIO_SOURCE_INVALID,
                        AUDIO_FLAG_BEACON, ""},
                      {AUDIO_CONTENT_TYPE_ULTRASOUND, AUDIO_USAGE_UNKNOWN, AUDIO_SOURCE_INVALID,
                        AUDIO_FLAG_NONE, ""},
                      {AUDIO_CONTENT_TYPE_UNKNOWN, AUDIO_USAGE_SPEAKER_CLEANUP,
                        AUDIO_SOURCE_INVALID,
                        AUDIO_FLAG_NONE, ""},
                      {AUDIO_CONTENT_TYPE_UNKNOWN, AUDIO_USAGE_NOTIFICATION_VIBRATION,
                        AUDIO_SOURCE_INVALID,
                        AUDIO_FLAG_NONE, ""},
                      {AUDIO_CONTENT_TYPE_UNKNOWN, AUDIO_USAGE_RINGTONE_VIBRATION,
                        AUDIO_SOURCE_INVALID,
                        AUDIO_FLAG_NONE, ""}
                  }
            }
    ...
    {"STRATEGY_REROUTING", static_cast<int>(AudioProductStrategyType::SYS_RESERVED_REROUTING),
     AudioProductStrategy::DEFAULT_ZONE_ID,
     {
         {AUDIO_STREAM_REROUTING, "AUDIO_STREAM_REROUTING",
          {{AUDIO_CONTENT_TYPE_UNKNOWN, AUDIO_USAGE_VIRTUAL_SOURCE, AUDIO_SOURCE_INVALID,
